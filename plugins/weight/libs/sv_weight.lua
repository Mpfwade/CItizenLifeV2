...
function ix.char.Create(data, callback)
    ...
    query:Callback(function(result, status, lastID)
        ...
        invQuery:Callback(function(invResult, invStats, invLastID)
            ...
            local w, h = 9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999, 9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
