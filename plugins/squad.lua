...
if CLIENT then
	...
	function PANEL:Init()
		...
		function self.CreateButton:DoClick()
			...
			local rdn_names = {
				"PT-UNION", "PT-HELIX", "PT-HERO", "PT-VICTOR", "PT-KING", "PT-DEFENDER",
				"PT-ROLLER", "PT-JURY", "PT-GRID", "PT-VICE", "PT-RAZOR", "PT-NOVA",
				"PT-SPEAR", "PT-JUDGE", "PT-SHIELD", "PT-YELLOW", "PT-LINE", "PT-TAP",
				"PT-STICK", "PT-QUICK"
			}
